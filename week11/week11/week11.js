...
function makeTwo() {
  //Ваш код
  let span = document.getElementById("practicum2");
...
function makeThree() {
  //Ваш код
  let heading = document.querySelector("#practicum3");
...
function makeFour() {
  //Ваш код
  let changeDivColor = document.querySelector("#practicum4");
  changeDivColor.style.background = "red";
}
...
function makeFive() {
  //Ваш код
  let input = (document.getElementById("practicum5").value = "Новое значение");
  // (как вариант)input.value = "Новое значение";
}
...
function makeSeven() {
  ...
  link.innerHTML = "Ссылка на Google";
}
...
function makeEight() {
  //Найдите элемент x
  let list = document.getElementById("practicum8");
...
function makeNine() {
  //Найдите элемент
  let element = document.getElementById("practicum9");
...
function makeTen() {
  //Ваш код
  let element = (document.getElementById("practicum10").style.display = "none");
...
function makeEleven() {
  //Ваш код
  let div = document.getElementById("practicum11");
...
function makeTwelve() {
  ...
  // div.classList.toggle("hight: 200px")
}
...
function makeThirteen() {
  //Ваш код
  let elements = (document.getElementsByTagName("ol")[0].innerHTML = "Привет!");
}
...
function makeFifteen() {
  //Ваш код
  let div = document.getElementById("practicum15");
  div.remove("pr practicum15");
}
...
function makeSixteen() {
  //Ваш код
  let div = document.getElementById("practicum16");
...
function makeSeventeen() {
  //Ваш код
  let divColor = document.getElementById("practicum17");
  divColor.classList.toggle("color");
}
...
function makeEighteen() {
  //Ваш код
  let divClassAdd = document.getElementById("practicum18");
  divClassAdd.classList.toggle("active");
}
...
function makeNineteen() {
  //Ваш код
  let divClassRemove = document.getElementById("practicum19");
  divClassRemove.classList.remove("active");
}
...
function makeTwenty() {
  //Ваш код
  let addElement = document.getElementById("practicum20");
  let addNewElement = document.createElement("p");
  addNewElement.textContent = "Я-новый элемент!";
  addElement.prepend(addNewElement);
}
...
function makeTwentyOne() {
  //Ваш код
  let divAddElement = document.getElementById("practicum21");
  let divCreateNewElement = document.createElement("p");
  divCreateNewElement.textContent = "Добавлено в конец.";
  divAddElement.append(divCreateNewElement);
}
...
function makeTwentyTwo() {
  ...
  let attribute = document.getElementById("practicum22");
  //2 шаг: Создайте переменную, которая проверяет наличие атрибута у найденного элемента
  let checkAttribute = attribute.hasAttribute("src");
  //3 шаг: Найдите элемент, в который нужно вставить значение
  let findElement = (document.getElementById("result22").innerHTML =
    "Атрибут src присутствует: " + checkAttribute);
  ...
  // findElement.textContent = "Атрибут "src" присутствует: " + checkAttribute;
}
...
function makeTwentyThree() {
  //Ваш код
  let attribute = document.getElementById("practicum23");
...
function makeTwentyFour() {
  //Ваш код
  let element = document.getElementById("practicum24");
  element.setAttribute("value", "Новое значение");
}
...
function makeTwentyFive() {
  //1 шаг: Найдите элемент
  let element = document.getElementById("practicum25");
  ...
  element.innerHTML = "Дополнительная информация";
  //4 шаг: Найдите элемент, в который нужно вставить значение из 3 шага
  let newElement = document.getElementById("infoOutput");
  ...
  newElement = "Добавленный атрибут" + element;
}
...
function makeTwentySeven() {
  //Найдите переменную
  let element = document.getElementById("practicum27");
  ...
  let checkResult = element.classList.contains("highlight");
...
//Ваш код
let input = document.getElementById("input29");
...
//Ваш код
let element = document.getElementById("div30");
